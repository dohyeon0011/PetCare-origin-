...
public class ReviewService {
    ...
    @Comment("리뷰 작성")
    @Transactional
    public Review saveReview(long customerId, AddReviewRequest request) {
        ...
        CustomerReservation customerReservation = customerReservationRepository.findById(request.getCustomerReservationId())
    ...
    @Comment("특정 회원의 특정 리뷰 조회")
    public ReviewResponse.GetDetail findById(long customerId, long reviewId) {
        Member customer = memberRepository.findById(customerId)
                .orElseThrow(() -> new NoSuchElementException("로그인한 회원을 찾을 수 없습니다."));

        return reviewRepository.findByCustomerReservationCustomerIdAndId(customer.getId(), reviewId)
    ...
    public ReviewResponse.GetDetail update(long customerId, UpdateReviewRequest request) {
        Member customer = memberRepository.findById(customerId)
                .orElseThrow(() -> new NoSuchElementException("로그인한 회원을 찾을 수 없습니다."));
        ...
        Review review = reviewRepository.findByCustomerReservationCustomerIdAndId(customer.getId(), request.getId())
                .orElseThrow(() -> new NoSuchElementException("해당 리뷰를 찾을 수 없습니다."));
